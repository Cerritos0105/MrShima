 ...
 * @author Think
 */
public class Vender_B_C extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Vender_B_C.class.getName());

    /**
     * Creates new form Vender_B_C
     */
    int idt=0;
    public Vender_B_C(int id) {
        initComponents();
        idt=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("VENDER BORDADORA A CREDITO");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Vender_B_C().setVisible(true));
    }
