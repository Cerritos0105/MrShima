 ...
 * @author lupit
 */
public class Tegedoras extends javax.swing.JFrame {

    /**
     * Creates new form Tegedoras
     */
    int Tabla_Id=0;
    public Tegedoras() {
        initComponents();
        Buscar_Tegedoras bu = new Buscar_Tegedoras();
        List<TegedorasO> lista= bu.busca_V();
        int id, anio, cabezas;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tegedoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
